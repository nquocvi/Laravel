                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="#">Add User</a></li>
                            <li><i class="fa fa-table"></i><a href="/admin/users/manage">List User</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="/admin/category/add">Add Category</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="/admin/category/view">List Category</a></li>
                        </ul>
                    </li>
